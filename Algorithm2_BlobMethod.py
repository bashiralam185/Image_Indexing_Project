...
def main():
    ...
    for img_f32, path in zip(imgs, paths):
        ...
        # 1) Detect blobs on the cropped image
        ...
        mask = keypoints_to_mask(keypoints, cropped.shape)
        ...
        if SHOW_DEBUG and debug_count < MAX_DEBUG:
            ...
            # RGB version of cropped version for drawing circles
    ...
    plt.legend()
    plt.grid(axis='y')
    plt.savefig("pred_vs_gt_blobs_barplot.png")
    plt.show()
